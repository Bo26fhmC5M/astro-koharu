...
export class Live2DWavFileHandler {
  ...
  private loadWavFile(filePath: string): Promise<boolean> {
...
class ByteReader {
  constructor() {
    this._fileByte = new ArrayBuffer(0);
    this._fileDataView = new DataView(this._fileByte);
    this._fileSize = 0;
    this._readOffset = 0;
  }
